...
def Simu_Optical_Conjugation(Sensor_Pixel_Size=None, Width_in_Pixels=None, Height_in_Pixels=None,
                             Focal_Length=None, Conj_Type=None, Central_pixel_horizontal_switch=None, Central_pixel_vertical_switch=None):
    """
    INPUTS :
    ...
    OUTPUTS :
    Incident_Rays_Azimuth_Matrix (入射光线方位角矩阵) and Incident_Rays_Elevation_Matrix (入射光线高度角矩阵) are in
    radian.
    ...
    Conj_Type possible valueS : (5种成像模型)
          r0 : perspective imaging -> thin lens model
          r1 : stereographic imaging
          r2 : equidistance imaging -> twice the incident angle, twice the image length
